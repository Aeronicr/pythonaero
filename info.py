...
class Info(commands.Cog, name="Info"):
    ...
    async def правила(self, ctx):
        ...
        embed.add_field(name="Загальні положення:",
                        value="Ласкаво просимо до серверу Славетного Славенія. Перш ніж ви поринете у спілкування, пропонуємо вам ознайомитись із призначеннями каналів та інформацією про їхнє використання! Кожен новий учасник на сервері може отримати початкову роль '@Новоприбулий'. Дана роль надає вам можливість спілкуватись в основних текстових каналах. Щоб підвищувати свою роль вам необхідно активно спілкуватись, адже пункти досвіду надаються за написані повідомлення. Після досягнення рівня '@Незнайомець' ви отримаєте доступ до деяких інших каналів. Канал '#славетний-плей-лист'  доступний користувачам, які досягли рівня '@Незнайомець'. За допомогою цього каналу ви можете задавати пісні, які хочете послухати у голосовому каналі '#славетні-пісні' . Варто зазначити, що доступ до каналу 'славетні-пісні' мають усі користувачі. Тобто, слухати музику можуть усі, але пропонувати свою лише користувачі, що мають певний рівень на сервері. Детальніше про команди музичного бота шукайте у закріплених повідомленнях каналу '#славетний-плей-лист'. Канали '#ганебна-сральня'  (політичний канал) та '#славетний-бордель' (еротичний канал) є специфічними та орієнтованими на аудиторію 18+. Тому, якщо вам менше років, не заходьте на ці канали. /n Щоб отримати доступ до цих каналів прочитайте інформацію, що подана нижче. Вам буде видана роль та доступ. Доступ до каналу можуть отримати користувачі із рівнем '@Незнайомець' та вище. Канали '#славетні-ігромани'  та '#граємо-разом' створені для обговорення різних ігор, кооперації у команди. Доступ до каналу мають усі користувачі, але для цього потрібно отримати відповідну роль. Детальніше про це шукайте нижче. Голосовий канал '#славетний-кінотеатр' створений для перегляду фільмів. Голосовий канал '#славетні-базіки' створений для спілкування учасників серверу із рівнем вищим за '@Незнайомець'.",inline=False)
        # embed.add_field(name="Синтаксис команди:", value="<префікс>команди", inline=False)
        # embed.add_field(name="Альтернативний виклик команди:", value="commands, com, ком", inline=False)
        # embed.add_field(name="Дозволені канали:", value="#славетні-боги, #флудильня", inline=False)
        await ctx.send(embed=embed)
